...
public class MockClusterDelegate extends BaseClusterDelegate {

    private static final Logger LOGGER = LoggerFactory.getLogger(MockClusterDelegate.class);

    public MockClusterDelegate(InstanceWAL instanceWAL, DataStorage storage) {
